...
import static com.dayu.singapp.materialcalendarview.MaterialCalendarView.showDecoratedDisabled;
import static com.dayu.singapp.materialcalendarview.MaterialCalendarView.showOtherMonths;
import static com.dayu.singapp.materialcalendarview.MaterialCalendarView.showOutOfRange;
...
class DayView extends CheckedTextView {
    ...
    private void setEnabled() {
        ...
        boolean showMonths = showOtherMonths(showOtherDates);
        boolean showRange = showOutOfRange(showOtherDates) || showMonths;
        boolean showDecorated = showDecoratedDisabled(showOtherDates);

        boolean shouldBeVisible = enabled;

        if (!isInMonth && showMonths) {
            shouldBeVisible = true;
        }

        if (!isInRange && showRange) {
            shouldBeVisible |= isInMonth;
        }

        if (isDecoratedDisabled && showDecorated) {
