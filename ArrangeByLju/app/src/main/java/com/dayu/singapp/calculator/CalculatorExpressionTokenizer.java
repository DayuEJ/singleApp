...
package com.dayu.singapp.calculator;
...
public class CalculatorExpressionTokenizer {
    ...
    public CalculatorExpressionTokenizer(Context context) {
        ...
        mReplacementMap.put("/", context.getString(R.string.desc_op_div));
        mReplacementMap.put("*", context.getString(R.string.desc_op_mul));
        mReplacementMap.put("-", context.getString(R.string.desc_op_sub));
