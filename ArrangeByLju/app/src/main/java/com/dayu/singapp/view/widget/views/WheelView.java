...
package com.dayu.singapp.view.widget.views;
...
public class WheelView extends View {
	...
	private boolean mIsNeedDrawPoint;
	/**
	 * Constructor
	 */
	...
	public WheelView(Context context, boolean isDrawPoint){
		super(context);
		this.mIsNeedDrawPoint = isDrawPoint;
		initData(context);
	}
...
//		setBounds(int left, int top, int right, int bottom)
	...
	private void drawCenterLine(Canvas canvas){
		...
		lintPaint.setColor(ResourceUtil.getColor(R.color.color_FF0084FF));
		lintPaint.setStrokeWidth(DeviceUtil.dp2Px(1));
//		canvas.drawLine(0, center - offset, getWidth() - DeviceUtil.dp2Px(6), center - offset, lintPaint);
//		canvas.drawLine(0, center + offset, getWidth() - DeviceUtil.dp2Px(6), center + offset, lintPaint);
		canvas.drawLine(0, center - offset, getWidth(), center - offset, lintPaint);
		canvas.drawLine(0, center + offset, getWidth(), center + offset, lintPaint);
	}
	...
	private void drawPoint(Canvas canvas){
		...
		int center = getHeight() / 2;
		int offset = (int) (getItemHeight() / 2 * 1.2);
		pointPaint.setColor(ResourceUtil.getColor(R.color.white));
		pointPaint.setStrokeWidth(DeviceUtil.dp2Px(2));
		canvas.drawPoint(getWidth() - DeviceUtil.dp2Px(3), center - offset / 4, pointPaint);
		canvas.drawPoint(getWidth() - DeviceUtil.dp2Px(3), center + offset / 4, pointPaint);
	}
