package com.dayu.singapp.materialcalendarview;
...
import com.dayu.singapp.materialcalendarview.format.DayFormatter;
import com.dayu.singapp.materialcalendarview.format.WeekDayFormatter;
...
import static com.dayu.singapp.materialcalendarview.MaterialCalendarView.SHOW_DEFAULTS;
import static com.dayu.singapp.materialcalendarview.MaterialCalendarView.showOtherMonths;
import static java.util.Calendar.DATE;
//https://www.jianshu.com/p/8396a4d39c01   参考文档
//https://www.jianshu.com/p/365f00b04256
...
abstract class CalendarPagerView extends ViewGroup implements View.OnClickListener {
    ...
    private static final Calendar tempWorkingCalendar = CalendarUtils.getInstance();//当前年月日
    ...
    //// TODO: 2018/1/31 this progress
    protected Calendar resetAndGetWorkingCalendar() {
        getFirstViewDay().copyTo(tempWorkingCalendar);//更新一个当前日期
        ...
        boolean removeRow = showOtherMonths(showOtherDates) ? delta >= 0 : delta > 0;//row 一行
        if (removeRow) {
