...
//                    break;
    ...
    private void initView(Context context) {
        setLayout(context);//生成ImageView
        //// TODO: 2017/6/8 为没一个ImageView配置动画
    ...
    private void setLayout(Context context) {
        LayoutParams params=new LayoutParams(DeviceUtil.dp2Px(72),DeviceUtil.dp2Px(72));
        //添加一个规则
        ...
        for (int i = 0; i < SIZE ; i++) {
            ...
            imgs[i].setImageResource(R.mipmap.ico_fake_call_wave);
...
//        img_bg.setImageResource(R.drawable.ic_intro_flash);
